...
function moveDino(e) {
    ...
    if ((e.code === "Space" || e.code == "Arrow Up") && dino.y == dinoY) {
        // jump
        velocityY = -10;
    }
}
...
function placeCactus() {
    ...
    else if (placeCactusChance > .70) { // 30% you get cactus 2
    ...
    if (cactusArray.length > 5) {
        cactusArray.shift(); // remove the first element of the array so that the array doesn't constantly grow
    }
}
